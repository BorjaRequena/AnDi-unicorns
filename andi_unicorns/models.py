...
class CNNLin(Module):
    def __init__(self, dim, vocab_sz=1, h_size=1000, yrange=(0, 2.05), exp=1, layers=[1, 1, 1, 1], out_p=0., linear_layers=[200, 50], ps=None, act=True, **kwargs):
...
class Hydra(Module):
    ...
    @staticmethod
    def _remove_last_layer(model): del model.blocks[-1].layers[-1]
